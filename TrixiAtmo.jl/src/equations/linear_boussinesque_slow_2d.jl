...
@muladd begin
    ...
    """
    struct LinearizedGravityWaveEquationsSlow2D{RealT <: Real} <:
    ...
    function LinearizedGravityWaveEquationsSlow2D(cs::Real, U::Real, fb::Real)
        return LinearizedGravityWaveEquationsSlow2D(cs, U, fb)
    end
    
    function varnames(::typeof(cons2cons), ::LinearizedGravityWaveEquationsSlow2D)
        ("u", "w", "p", "b")
    end
    function varnames(::typeof(cons2prim), ::LinearizedGravityWaveEquationsSlow2D)
        ("u", "w", "p", "b")
    end
    ...
    function initial_condition_convergence_test(x, t,
        equations::LinearizedGravityWaveEquationsSlow2D)
        A = 5000
        H = 10000
        b0 = 0.01
        xc = 0.0
    ...
    @inline function rotate_to_x(u, normal_vector, equations::LinearizedGravityWaveEquationsSlow2D)
    ...
    @inline function flux(u, normal_direction::AbstractVector,
        ...
        f1 = v1*U*normal_direction[1]
        f2 = v2*U*normal_direction[1]
        f3 = U*p*normal_direction[1] 
        f4 = U*b*normal_direction[1]
    
        return SVector(f1, f2, f3, f4)
    end
    
    @inline have_constant_speed(::LinearizedGravityWaveEquationsSlow2D) = True()
    
    @inline function max_abs_speeds(equations::LinearizedGravityWaveEquationsSlow2D)
        @unpack cs = equations
        return cs, cs
    end
    ...
    @inline function flux_lmars(u_ll, u_rr, normal_direction::AbstractVector,
        ...
        if normal_direction[1] < 0
            f1 = U*v1_rr*normal_direction[1]
            f2 = U*v2_rr*normal_direction[1]
            f3 = U*p_rr*normal_direction[1]
            f4 = U*b_rr*normal_direction[1]
        else
            f1 =  U*v1_ll*normal_direction[1]
            f2 = U*v2_ll*normal_direction[1]
            f3 = U*p_ll*normal_direction[1]
            f4 = U*b_ll*normal_direction[1]
        end
    ...
    @inline cons2prim(u, equations::LinearizedGravityWaveEquationsSlow2D) = u
    @inline cons2entropy(u, ::LinearizedGravityWaveEquationsSlow2D) = u
    end # muladd
